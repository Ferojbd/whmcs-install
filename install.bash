...
# Configuration
WHMCS_INSTALL_DIR="/var/www/billing"   # Update this to your preferred installation directory
DB_USER="itpolly_billing"        # Replace with your database username
DB_PASS="59+4jVI3`znj"    # Replace with your database password
DB_NAME="itpolly_billing"            # Replace with your database name
